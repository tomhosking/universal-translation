...
for attempt in range(2):
    with tf.Session(graph=graph) as session:
      ...
      data={'embeddings':final_embeddings.tolist(), 'dictionary': dictionary, 'reverse_dictionary':reverse_dictionary}
      import json
      with open('embeddings_'+str(embedding_size)+'_'+str(attempt)+'.json', 'w') as outfile:
